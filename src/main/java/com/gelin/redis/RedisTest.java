...
public class RedisTest {
    ...
    @Before
    public void setUp() {
        pool = new JedisPool(new JedisPoolConfig(), "192.168.3.97");

        jedis = pool.getResource();
        jedis.auth("gelin");//密码在server.windows.cofg，中改
    }
    ...
    public void testBasicString() {
        //-----添加数据----------
        jedis.set("name", "gelin");//向key-->name中放入了value-->minxr
