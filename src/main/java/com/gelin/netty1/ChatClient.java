...
//
//import com.gelin.netty1.SecureChatClientInitializer;
...
//		try {
//			//负责接受一个用户默认的用户名
//			String a=JOptionPane.showInputDialog("Input your nickname please！");//输入的值
//			if(a!=null){
...
//		b.group(clientGroup).channel(NioSocketChannel.class).handler(new SecureChatClientInitializer(sslctx));//这里进入SecureChatClientInitializer的构造方法
