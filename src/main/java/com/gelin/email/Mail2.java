 ...
 *//*
        ...
        //    真正要发送时, 邮箱必须是真实有效的邮箱。
        message.setFrom(new InternetAddress("962422150@qq.com", "USER_AA", "UTF-8"));

        // 3. To: 收件人
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress("gllovejava@163.com", "USER_CC", "UTF-8"));
        //    To: 增加收件人（可选）
        */
